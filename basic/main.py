...
# Train the task priority classifier (only if data exists)
def train_model():
    if not tasks.empty:
...
def add_task(description, priority):
    ...
    save_tasks()
    model = train_model()  # Retrain model after adding a new task
...
def remove_task(description):
    ...
    save_tasks()
    model = train_model()  # Retrain model after removing a task
